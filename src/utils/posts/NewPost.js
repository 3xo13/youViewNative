...
const NewPost = ({ userId, setCreatingNewPost, balance, user }) => {
			...
			<View style={styles.bodyWrapper}>
				...
				<View style={[styles.inputWrapper, styles.inputWrapperBox]}>
					...
					<View style={styles.sliderWrapper}>
						<Text style={styles.whiteText}>{time} s</Text>
						<Slider
							step={5}
							minimumValue={45}
							maximumValue={3600}
				...
				<View style={[styles.inputWrapper, styles.inputWrapperBox]}>
					...
					<View style={styles.sliderWrapper}>
						<Text style={styles.whiteText}>{views} v</Text>
						<Slider
							step={5}
							minimumValue={5}
							maximumValue={4000}
				...
				{/* submit or topup button with post cost */}
